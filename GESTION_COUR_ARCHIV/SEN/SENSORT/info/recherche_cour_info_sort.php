...
<header id="header">
        <nav class="navbar navbar-fixed-top" role="banner">
            ...
            <li><a href="recherche_cour_info.php">Courriers entrants d'Info</a></li>
                     <li><a href="recherche_cour_info_sort.php">Courriers sortants d'Info</a></li>
           <li><a href="tab_gene_info.php">Tous les courriers d'Info</a></li> 
...
$(document).ready(function(){
	$('#s-results').load('search_date_info_sort.php').show();
	...
	function showValues() {
		...
		$.post('search_date_info_sort.php', { mois: form.mois.value,annee: form.annee.value, },
