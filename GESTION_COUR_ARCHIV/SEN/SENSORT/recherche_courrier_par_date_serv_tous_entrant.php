...
<div>
 ...
 <p align="center" style="font-size:28px;color:white;"> </p>
     ...
     <h2 style="color:white;font-size:19px" class="animated fadeInRight">RAPPORT DES COURRIERS SORTANTS DES TOUS LES SERVICES PAR  MOIS ET ANNEE</h2>
     </div>
...
$(document).ready(function(){
	$('#s-results').load('search_serv_entr_tous_serv.php').show();
	...
	function showValues() {
		$('#s-results').html('<img src="img3/loader.gif" />');  
		
		$.post('search_serv_entr_tous_serv.php', { mois: form.mois.value,annee: form.annee.value },
