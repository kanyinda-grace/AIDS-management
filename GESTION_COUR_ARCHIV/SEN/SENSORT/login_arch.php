...
$_SESSION['uname_agent']=$data['uname_agent_daf'];
$_SESSION['mat_agent']=$data['mat_agent'];
$_SESSION['nom_agent']=$data['nom_agent'];
$_SESSION['postnom_agent']=$data['postnom_agent'];
$_SESSION['prenom_agent']=$data['prenom_agent'];
header("location:archivage.php");
}
else
{
 ...
 <img src="img3/logo.png"  style="width:1200px;height:115px;width:50%;margin-top:-50px;margin-left:400px;" alt="" />
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-80px;" >
    ...
    <form action=""   method="post" enctype="multipart/form-data" name="" > </br>
     ...
     <div  class="text-center" style="background-color: #00BFFF;border-radius:6px;height:70px;width:50%;" > </br>
  ...
  <div class="row h-100 justify-content-center align-items-center">
    ...
    if(isset($message)){
     ...
     <div align="center" style="margin-top:-40px;"  class="animated slideInLeft"  >

     <div class="form-row justify-content-center" >
       <div class="col-5" >
              <label style="color:#00BFFF;font-size:22px;margin-left:-273px;">Nom d'utilisateur </label></br>
           <input type="text" name="uname_agent_daf"  class="form-control" id="formGroupExampleInput" placeholder="nom d'utilisateur" required style="border-color:silver;width:40%">
       </div> </br> 
       <div class="col-7 my-1">
                  <label style="color:#00BFFF;font-size:22px;margin-left:-323px;">Mot de Passe</label></br>

           <input type="password" name="upass_agent_daf" class="form-control" id="formGroupExampleInput" placeholder="Mot de Passe" required style="border-color:silver;width:40%">
      </div></br> 
      <div class="form-row justify-content-center">
         <div class="col-7  my-1">
             <button type="submit" name="submit" class="btn btn-info btn-block" style="background-color: #00BFFF; color: #fff;font-size:23px;width:40%;font-family:verdana">Se Connecter</button>
         </div>
      </div>
     </div> </br></br>
