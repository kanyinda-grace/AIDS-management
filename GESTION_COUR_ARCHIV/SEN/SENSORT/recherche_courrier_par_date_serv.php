        ...
        <nav class="navbar navbar-fixed-top" role="banner">
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-left">
                   ...
                   <li><a href="rapport.php" style="color:white;font-family:sans-serif;font-size:18px">Accueil</a></li>
...
<div>
 ...
 <p align="center" style="font-size:28px;color:white;"> </p>
         ...
         echo '<p align="center"    style="color:red;font-family:verdana; font-size:20px;">'.$_SESSION['nom_agent_sen'].' '.$_SESSION['postnom_agent_sen'].' '.$_SESSION['prenom_agent_sen'].'</p>';


        $_SESSION['mat_agent_sen'];?>

     <div  class="text-center" style="background-color: #00BFFF;border-radius:6px;width:80%" align="center">
     <h2 style="color:white;font-size:19px" class="animated fadeInRight">RAPPORT DES COURRIERS SORTANTS PAR SERVICE , MOIS ET ANNEE</h2>
     </div>
	      <div class="col-7 my-1">
	   	            <label style="color: #00BFFF;font-size:20px;">Service</label></br>

              <select  name="code_service" class = "form-control" id="formGroupExampleInput" style="border-radius:6px;;color:black;background-color:white;border-color:silver;width:342px"  >
...
<?php
      ...
      ?>
	       ...
	       <div class="col-7  my-3">
             <button type="submit" value="Search" id="search-btn"class="btn btn-info btn-block" style="background-color: #00BFFF; color: #fff;font-size:23px;width:14%;font-family:verdana;margin-top:10px;margin-left:174px"> Rechercher </button>
...
$(document).ready(function(){
	$('#s-results').load('search_serv.php').show();
	...
	function showValues() {
		...
		$.post('search_serv.php', { mois: form.mois.value,annee: form.annee.value,code_service: form.code_service.value },
