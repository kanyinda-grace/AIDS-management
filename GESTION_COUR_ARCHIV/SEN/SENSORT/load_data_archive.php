	...
	<tbody >
                 ...
                 <td align='left' style='border-width:1px;border-style:solid;border-color:black;font-size:20px;'>                  
                     <strong></strong> ".$donnees['id_courrier_archive']." <br />  
					        ...
					        <td align='left' style='border-width:1px;border-style:solid;border-color:black;font-size:20px;'>  
                     <strong></strong> ".$donnees['mat_agent']." <br />
					  </td>
					    <td align='left' style='border-width:1px;border-style:solid;border-color:black;font-size:20px;'>  
...
<div align='center' style='font-size:20px;font-weight:bold;color:red;'>LISTE DES COURRIERS ARCHIVES</div> 

<table border='0' cellspacing='1' width='100%' align='center' class='table table-bordered animated zoomIn' style='border-width:1px;border-style:solid;border-color:black;width:80%' >
            <thead  class=''  >
                <tr style='background-color:#00BFFF;' style='border-width:1px;border-style:solid;border-color:black;'>
					...
					<th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:20px'>Mat_Agent</div></th>
					...
					<th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:20px'>Date D'enregistrement </div></th>
