...
where  service.code_service='PRC' LIMIT $start, $per_page");
...
<div align='center' style='font-size:18px;font-weight:bold;color:#00BFFF;'>LISTE DE TOUS LES COURRIERS DE LA PLANIFICATION ET RENFORCEMENT DES CAPACITES</div> 
