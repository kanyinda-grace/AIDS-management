...
<div align='center' style='font-size:18px;font-weight:bold;color:red;'>LISTE DE TOUS LES COURRIERS SORTANTS DU DAF</div> 
...
<table border='0' cellspacing='1' width='100%' align='center' class='table table-bordered' style='border-width:1px;border-style:solid;border-color:black;width:70%' >
  ...
  $users=$db->prepare("SELECT COUNT(*) AS count  FROM courrier_sort ");
$data=$users->fetch();
$ttgg=$data['num_lettre_sort'];
echo $ttgg ;
