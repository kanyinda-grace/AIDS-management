...
<div style='display:none;'>
 ...
 <p align="center" style="font-size:28px;color:white;"> </p>
     ...
     <h1 style="color:white;font-size:23px;" class="animated fadeInRight">RECHERCHE DES COURRIERS ENTRANTS PAR MOIS ET ANNEE</h1>
     </div>
...
$(document).ready(function(){
	...
	function showValues() {
		...
		$.post('search.php', { mois: form.mois.value,annee: form.annee.value, },
