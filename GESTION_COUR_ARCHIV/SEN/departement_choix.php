...
<body>
 ...
 <img src="img3/logo.png"  style="width:1200px;height:70px;width:30%;margin-top:-50px" alt="" />
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-70px;" >
    ...
    <a  href="gest_cour_archiv.php" style="text-decoration:none" >
     <div  class="text-center" id="tonga" style="background-color:   #00BFFF;border-radius:6px;height:55px;width:40%;"> </br>
	<div align="left" style="color:white;font-size:16px;font-weight:bold">GESTION DES COURRIERS ENTRANTS</div>

     </div></br>
	 </a>

    <a  href="SENSORT/gest_cour_archiv.php" style="text-decoration:none" >
     <div  class="text-center" id="tonga" style="background-color:   #00BFFF;border-radius:6px;height:55px;width:40%;"> </br>
  <div align="left" style="color:white;font-size:16px;font-weight:bold">GESTION DES COURRIERS SORTANTS</div>

     </div></br>
   </a>
	 
	  <a   href="tab_courr_cour_gene_tous.php"  style="text-decoration:none">
     <div  class="text-center" id="tonga" style="background-color:  #00BFFF;border-radius:6px;height:55px;width:40%;"> </br>
     <div align="left" style="color:white;font-size:16px;font-weight:bold">RAPPORT GENERALE DE TOUS LES COURRIERS </div>
     </div></br>
	 </a>

    <a   href="admin.php"  style="text-decoration:none">
     <div  class="text-center" id="tonga" style="background-color:  #00BFFF;border-radius:6px;height:55px;width:40%;"> </br>
     <div align="left" style="color:white;font-size:16px;font-weight:bold">ADMINISTRATION </div>
     </div></br>
   </a>
</div>
