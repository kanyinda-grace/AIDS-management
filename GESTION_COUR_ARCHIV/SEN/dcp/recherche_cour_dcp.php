...
<header id="header">
      ...
      <li><a href="../departement_sen.php" style="color:white;font-family:sans-serif;font-size:18px">Accueil</a></li>
            <li><a href="recherche_cour_dcp.php" style="color:white;font-family:sans-serif;font-size:18px">Courriers entrants Cop et Part</a></li>
                     <li><a href="recherche_cour_dcp_sort.php" style="color:white;font-family:sans-serif;font-size:18px">Courriers sortants Cop et Part</a></li>
           <li><a href="tab_gene_dcp.php" style="color:white;font-family:sans-serif;font-size:18px">Tous les courriers de Cop et Part</a></li> 
             </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
...
<div style='display:none;'>
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-160px;" >
    ...
    <form action=""    name="form" > </br>
     ...
     <div  class="text-center" style="background-color: #00BFFF;border-radius:6px;width:85%" align="center">
     <h2 style="color:white;font-size:19px" class="animated fadeInRight">RECHERCHE DES COURRIERS ENTRANTS DE LA COPERATION ET PARTENARIAT PAR MOIS ET ANNEE</h2>
     </div>
...
$(document).ready(function(){
	$('#s-results').load('search_date_dcp.php').show();
	...
	function showValues() {
		...
		$.post('search_date_dcp.php', { mois: form.mois.value,annee: form.annee.value, },
