...
left join agent on courrier_sort.mat_agent=agent.mat_agent  where service.code_service='CP' 
...
<div align='center' style='font-size:18px;font-weight:bold;color:red;'>LISTE DE TOUS LES COURRIERS  DE LA COPERATION ET PARTENARIAT</div> 
