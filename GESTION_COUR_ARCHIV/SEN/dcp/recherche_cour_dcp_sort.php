...
<div style='display:none;'>
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-160px;" >
    ...
    <form action=""    name="form" > </br>
     ...
     <h2 style="color:white;font-size:19px" class="animated fadeInRight">RECHERCHE DES COURRIERS SORTANT DE LA COPERATION ET PARTENARIAT PAR MOIS ET ANNEE</h2>
     </div>
...
$(document).ready(function(){
	$('#s-results').load('search_date_dcp_sort.php').show();
	...
	function showValues() {
		...
		$.post('search_date_dcp_sort.php', { mois: form.mois.value,annee: form.annee.value, },
