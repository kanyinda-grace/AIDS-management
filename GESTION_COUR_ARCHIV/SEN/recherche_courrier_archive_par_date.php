            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-left">
                    <ul class="nav navbar-nav">
                      <li><a href="archivage.php" style="color:white;font-family:sans-serif;font-size:18px">Accueil</a></li>
...
<div>
 ...
 <p align="center" style="font-size:28px;color:white;"> </p>
         ...
         echo '<p align="center"    style="color:red;font-family:verdana; font-size:20px;"> '.$_SESSION['nom_agent'].' '.$_SESSION['postnom_agent'].' '.$_SESSION['prenom_agent'].'</p>';


        $_SESSION['mat_agent'];?>
     
     <div  class="text-center" style="background-color: #00BFFF;border-radius:6px;">
     <h1 style="color:white;font-family:sans-serif;font-size:18px"  class="animated fadeInLeft">RECHERCHE DES COURRIERS ARCHIVES </h1>
     </div></br>
...
$(document).ready(function(){
	$('#s-results').load('search_archive.php').show();
	...
	function showValues() {
		...
		$.post('search_archive.php', { mois: form.mois.value,annee: form.annee.value, },
