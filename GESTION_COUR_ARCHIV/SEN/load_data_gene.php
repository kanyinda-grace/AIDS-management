...
$reponse =$db->query( "SELECT courrier_ent.num_lettre_ent,service.code_service,service.libelle_service,
 agent.code_departement,courrier_ent.objet_ent,courrier_ent.jour_ent,courrier_ent.mois_ent,courrier_ent.annee_ent,courrier_ent.observation_ent,courrier_ent.code_sexe,courrier_ent.nom_ent,courrier_ent.postnom_ent,courrier_ent.prenom_ent,courrier_ent.entreprise_ent,courrier_ent.email_ent,
...
join agent on courrier_ent.mat_agent=agent.mat_agent
 ORDER BY courrier_ent.num_lettre_ent LIMIT $start, $per_page");

  $users=$db->prepare("select count(num_lettre_ent) as tota from courrier_ent ");
...
"<div style='color:#00BFFF;font-size:17px;margin-left:135px;font-family:verdana;font-weight:bold'>Nombre total des tous les courriers : <b style='color:black;font-family:verdana;font-weight:bold'>".$ttgg."</b> </div>";
...
<div align='center' style='font-size:18px;font-weight:bold;color:red;'>LISTE DES COURRIERS ENTRANTS DE TOUS LES SERVICES</div> 
...
<table border='0' cellspacing='1' width='100%' align='center' class='table table-bordered' style='border-width:1px;border-style:solid;border-color:black;width:70%' >
         <thead  class=''  >
                ...
                <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:16px'>NUMERO LETTRE ENTRANTE</div></th>
                <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>DATE D'ENREGISTREMENT</div></th>
                          <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>DESTINATEUR</div></th>

             <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>OBJET</div></th>
          <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>SERVICE</div></th>
                    <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>COMMENTAIRE</div></th>

          <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>OBSERVATION </div></th>
         <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:17px'>ALERTE</div></th>
