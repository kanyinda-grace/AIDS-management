...
if( empty( $jour ) and empty( $mois ) and empty( $annee )){
	...
	$sql =$db->query( "SELECT courrier_ent.num_lettre_ent,service.code_service,service.libelle_service,courrier_sort.num_lettre_sort,
...
join courrier_ent on courrier_sort.num_lettre_ent=courrier_ent.num_lettre_ent 
join service on courrier_ent.code_service=service.code_service 
join agent on courrier_sort.mat_agent=agent.mat_agent  and  mois_sort='$mois' and annee_sort='$annee' and service.code_service='DAFF' 
...
join courrier_ent on courrier_sort.num_lettre_ent=courrier_ent.num_lettre_ent 
join service on courrier_ent.code_service=service.code_service 
join agent on courrier_sort.mat_agent=agent.mat_agent  and  mois_sort='$mois' and annee_sort='$annee' and service.code_service='DAFL' 
...
join courrier_ent on courrier_sort.num_lettre_ent=courrier_ent.num_lettre_ent 
join service on courrier_ent.code_service=service.code_service 
join agent on courrier_sort.mat_agent=agent.mat_agent  and  mois_sort='$mois' and annee_sort='$annee' and service.code_service='DAFR' 
...
";
	echo" <tr   style='background-color:#0F9DE8;'  style='border-width:1px;border-style:solid;border-color:white;' >
                    ...
                    <th style='border-width:1px;border-style:solid;border-color:black;padding:6px;'><div style='color:white;font-size:16px'>Numéro lettre sortante</div></th>
                ...
                <tr valign='top' style='color:black;font-weight:bold;background-color:white;'>
                   ...
                   <td align='left' style='border-width:1px;border-style:solid;border-color:black;font-size:16px;padding:6px;'>  
                     ...
                     <strong></strong> ".$donnees['num_lettre_sort']." <br />
					    ...
					    <td align='left' style='border-width:1px;border-style:solidhyuhu;border-color:black;font-size:16px;padding:6px;'>  
