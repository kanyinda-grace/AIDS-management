...
<header id="header">
        <nav class="navbar navbar-fixed-top" role="banner">
            ...
            <li><a href="recherche_cour_daf.php"  style="color:white;font-family:sans-serif;font-size:18px">Courriers entrants daf</a></li>
                     <li><a href="recherche_cour_daf _sort.php"  style="color:white;font-family:sans-serif;font-size:18px">Courriers sortants daf</a></li>
           <li><a href="tab_gene_daf.php"  style="color:white;font-family:sans-serif;font-size:18px">Tous les courriers du daf</a></li> 
...
<div style='display:none;'>
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-160px;" >
    ...
    <form action=""    name="form" > </br>
     ...
     <h2 style="color:white;font-size:19px" class="animated fadeInRight">RECHERCHE DES COURRIERS SORTANTES DU DAF PAR MOIS ET ANNEE</h2>
     </div>
...
$(document).ready(function(){
	$('#s-results').load('search_date_daf_sort.php').show();
	...
	function showValues() {
		...
		$.post('search_date_daf_sort.php', { mois: form.mois.value,annee: form.annee.value, },
