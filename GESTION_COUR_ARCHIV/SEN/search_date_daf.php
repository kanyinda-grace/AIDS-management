...
where agent.code_departement='SEN'  and service.code_service='DAFF' and  mois_ent='$mois' and annee_ent='$annee'
...
where agent.code_departement='SEN'   and service.code_service='DAFL' and  mois_ent='$mois' and annee_ent='$annee'
UNION ALL
...
where agent.code_departement='SEN'  and service.code_service='DAFR' and  mois_ent='$mois' and annee_ent='$annee'
");
...
";
echo" <tr   style='background-color:#0F9DE8;'  style='border-width:1px;border-style:solid;border-color:black;' >
