 ...
 <img src="img3/logo.png"  style="width:1200px;height:70px;width:30%;margin-top:-50px" alt="" />
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-70px;" >
    ...
    <a   href="archive.php"  style="text-decoration:none">
     ...
     <div align="left" style="color:white;font-size:16px;font-weight:bold">GESTION D'ARGIVAGE DES COURRIERS</div>
     </div></br>
   </a>

     <a   href="recherche_courrier_archive_par_date.php"  style="text-decoration:none">
     <div  class="text-center" id="tonga" style="background-color:  #00BFFF;border-radius:6px;height:55px;width:40%;"> </br>
     <div align="left" style="color:white;font-size:16px;font-weight:bold">RECHERCHER DE COURRIERS ARCHIVES</div>
     </div></br>
   </a>
    <a   href="tab_archiv_cour.php"  style="text-decoration:none">
     <div  class="text-center" id="tonga" style="background-color:  #00BFFF;border-radius:6px;height:55px;width:40%;"> </br>
     <div align="left" style="color:white;font-size:16px;font-weight:bold">LISTE DES COURRIERS ARCHIVES</div>
     </div></br>
   </a>
