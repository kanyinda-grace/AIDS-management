...
left join agent on courrier_sort.mat_agent=agent.mat_agent  where service.code_service='INFO' 
...
<div align='center' style='font-size:18px;font-weight:bold;color:red;'>LISTE DE TOUS LES COURRIERS  DE L'INFORMATIQUE</div> 
