...
<script type="text/javascript" src="qy/pages.js"></script>        
...
<div style=" background-color: #ffffff;" class="table-bordered"    >
	...
	<div align="left">
 <img src="img3/logo.png"  style="width:100px;height:100px;width:20%;margin-top:-10px" alt="" /> 
...
<div class="add" align="right"  ><a style="color:white;font-size:20px;margin-top:-70px;" onclick="javascript:printDiv('printablediv')" style="color:white;font-size:15px;background-color:red" name="print" style="cursor:pointer;" class="btn btn-info"><i class="icon-white icon-print"  ></i> Imprimer</a></div>
	</div>
