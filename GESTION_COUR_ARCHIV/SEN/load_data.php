...
$reponse =$db->query( "SELECT courrier_ent.num_lettre_ent,service.code_service,service.libelle_service,courrier_ent.libelle_type_document_ent,
...
$meme="<b style='color:orange'>il reste encore $x jours</b>" ;
  ...
  if ( $trdat> $exp and $ob=="Déjà traité"  ) {
...
<html>
  ...
  <tbody >
          ...
          <td align='left' style='border-width:1px;border-style:solid;border-color:black;font-size:16px;'>  
                 ...
                 <td align='left' style='border-width:1px;border-style:solid;border-color:black;font-size:16px;'>             
                    <a style='word-wrap:break-word;color:black;font-family:verdana' href='modif_traitement.php?modify=".$donnees['num_lettre_ent']."' ?> <div style='word-wrap:break-word;color:black;font-family:verdana' > ".$donnees['observation_ent']."</a></div> 
                 </td>
...
<div align='center' style='font-size:20px;font-weight:bold;color:red'>LISTE DES COURRIERS ENTRANTS</div> 
...
<table border='0' cellspacing='1' width='100%' style='width:99%'align='center' class='table table-bordered animated bounceInRight' style='border-width:1px;border-style:solid;border-color:black;' >
            <thead  class=''  >
                ...
                <th style='border-width:1px;border-style:solid;border-color:black;'><div style='color:white;font-size:16px'>DESTINATEUR DU COURRIER</div></th>
