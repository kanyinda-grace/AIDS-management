...
<header id="header">
        <nav class="navbar navbar-fixed-top" role="banner">
         ...
         <li><a href="../departement_sen.php" style="color:white;font-family:sans-serif;font-size:18px">Accueil</a></li>
            <li><a href="recherche_cour_dac.php" style="color:white;font-family:sans-serif;font-size:18px" >Courriers entrants d'AC</a></li>
                     <li><a href="recherche_cour_dac_sort.php" style="color:white;font-family:sans-serif;font-size:18px">Courriers sortants d'AC</a></li>
           <li><a href="tab_gene_dac.php" style="color:white;font-family:sans-serif;font-size:18px">Tous les courriers d'AC</a></li>
...
<div style='display:none;'>
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-160px;" >
    ...
    <form action=""    name="form" > </br>
     ...
     <h2 style="color:white;font-size:17px" class="animated fadeInRight">RECHERCHE DES COURRIERS SORTANTS DE L'AUDIT ET CONTENTIEUX PAR MOIS ET ANNEE</h2>
     </div>
...
$(document).ready(function(){
	$('#s-results').load('search_date_dac_sort.php').show();
	...
	function showValues() {
		...
		$.post('search_date_dac_sort.php', { mois: form.mois.value,annee: form.annee.value, },
