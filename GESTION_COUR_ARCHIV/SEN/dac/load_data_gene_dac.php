...
left join agent on courrier_sort.mat_agent=agent.mat_agent  where service.code_service='AC' 
...
<div align='center' style='font-size:18px;font-weight:bold;color:red;'>LISTE DE TOUS LES COURRIERS  DE L'AUDIT ET CONTENTIEUX</div> 
