...
where agent.code_departement='SEN'  and service.code_service='DAFF'


UNION ALL
SELECT courrier_ent.num_lettre_ent,service.code_service,service.libelle_service,
 agent.code_departement, courrier_ent.objet_ent,courrier_ent.jour_ent,courrier_ent.mois_ent,
 courrier_ent.annee_ent,courrier_ent.observation_ent,
 courrier_ent.code_sexe,courrier_ent.nom_ent,courrier_ent.postnom_ent,courrier_ent.prenom_ent,
 courrier_ent.entreprise_ent,courrier_ent.email_ent,
...
where agent.code_departement='SEN'   and service.code_service='DAFL' 
UNION ALL
...
where agent.code_departement='SEN'  and service.code_service='DAFR'  LIMIT $start, $per_page");
...
<div align='center' style='font-size:18px;font-weight:bold;color:red;'>LISTE DE TOUS LES COURRIERS ENTRANTS DU DAF</div> 
