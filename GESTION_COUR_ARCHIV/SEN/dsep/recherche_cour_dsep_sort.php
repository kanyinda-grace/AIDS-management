...
<header id="header">
        <nav class="navbar navbar-fixed-top" role="banner">
          ...
          <li><a href="../departement_sen.php" style="color:white;font-family:sans-serif;font-size:18px">Accueil</a></li>
            <li><a href="recherche_cour_dsep.php" style="color:white;font-family:sans-serif;font-size:18px">Courriers entrants de Sep</a></li>
                     <li><a href="recherche_cour_dsep_sort.php" style="color:white;font-family:sans-serif;font-size:18px">Courriers sortants de Sep</a></li>
           <li><a href="tab_gene_dsep.php" style="color:white;font-family:sans-serif;font-size:18px">Tous les courriers de Sep</a></li>  
...
<div style='display:none;'>
  ...
  <div class="row h-100 justify-content-center align-items-center" style="margin-top:-160px;" >
    ...
    <form action=""    name="form" > </br>
     ...
     <h2 style="color:white;font-size:17px" class="animated fadeInRight">RECHERCHE DES COURRIERS SORTANTS DU SECRETARIAT ET PROTOCOLE PAR MOIS ET ANNEE</h2>
     </div>
...
$(document).ready(function(){
	$('#s-results').load('search_date_dsep_sort.php').show();
	...
	function showValues() {
		...
		$.post('search_date_dsep_sort.php', { mois: form.mois.value,annee: form.annee.value, },
